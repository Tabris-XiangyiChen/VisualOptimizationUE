...
Source package:
`I:\Disertation\VisualOptimise\outputs\runs\20260823_203306_overworld_ruins_level_files_runtime_export\03_runtime_data_package`
...
```powershell
Copy-Item -Path "I:\Disertation\VisualOptimise\outputs\runs\20260823_203306_overworld_ruins_level_files_runtime_export\03_runtime_data_package\*" -Destination "I:\Disertation\VisualOptimizationUE\Content\VisualOptimization\RuntimeData" -Recurse -Force
```
